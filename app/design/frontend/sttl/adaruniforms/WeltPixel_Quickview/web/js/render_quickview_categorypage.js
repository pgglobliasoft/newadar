  ...
  'mage/requirejs/json!Sttl_Customerorder/template/Inventory.json',
], function($,mageTemplate,quickviewpopup,mageprojson,inventory) {
    'use strict';
    var simpleproduct = [],
    ...
    $.widget('mage.PopupRenderer', {
        ...
        _create: function () {
            ...
            if($widget.options.action === "customerorder-customer-neworder"){
                viewstockvisisble = 0;
            }
                $widget.setdata();
        },
        ...
        _EventListener: function () {
            ...
            $(document).keyup(function(e){
                 ...
                 //    }else if($('#popupModal').hasClass('show') && !$('.imgquickViewCont').hasClass('_show') && !$('#quickcheckout').hasClass('show')){
        ...
        quickviewpopuphtml: function($widget,psku){
            ...
            var falg = _.filter(this.options.parentstyledata, function(value) {
                  return value['Style'] == config[0].id;
            });
                ...
                var styleconfiguration = mageTemplate(quickviewpopup, {
                        ...
                        logindata: login,
                        viewstockvisi: viewstockvisisble,
                        falg: falg
                    });            
