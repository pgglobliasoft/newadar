...
class Categorys extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection()
    {
		...
		$tableName   = $connection->getTableName('vsourz_imagegallery_image_category');
		
        $collection->getSelect()->joinLeft(array('image_category' => $tableName),'image_category.image_id = '.$imageId.' AND main_table.category_id = image_category.category_id ',array('image_category.position'))->order('image_category.position','asc'); 
		}
