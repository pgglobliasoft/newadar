...
class Toolbar extends \Magento\Framework\View\Element\Template
{
    ...
    {
        if($this->getChildBlock('post_list_toolbar_pager_custom'))
        {
          $pagerBlock = $this->getChildBlock('post_list_toolbar_pager_custom');
        }
        if($this->getChildBlock('post_list_toolbar_pager'))
        {
