    ...
    var Lazyload = function (options) {
        ...
        function startLoading()
        {
            if (that.opt.current_page < that.opt.last_page && !that.loading) {
                that.loading = true;
                console.log(that.opt.trigger_element);
                if(that.opt.trigger_element == ".mbblog-lazyload-trigger")
                {
                  $('.mfblog-show-onload').show();
                  $('.mfblog-hide-onload').hide();
                }
                if(that.opt.trigger_element == ".mbblog-lazyload-triggercustom")
                {
                  $('.mfblog-show-onloadcustom').show();
                  $('.mfblog-hide-onloadcustom').hide();
                }
