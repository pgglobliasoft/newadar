...
class SliderItem extends \Magento\Framework\View\Element\Template
{
    ...
    const STYLESLIDE_CAROUSEL_TEMPLATE = 'Magestore_Bannerslider::slider/carousel.phtml';
    const STYLESLIDE_INSTAGAM_TEMPLATE = 'Magestore_Bannerslider::slider/instagam.phtml';
    const STYLESLIDE_MOBILE_TEMPLATE = 'Magestore_Bannerslider::slider/mobile.phtml';
    ...
    public function setStyleSlideTemplate($styleSlideId)
    {
        switch ($styleSlideId) {
            ...
            case SliderModel::STYLESLIDE_SPECIAL_NOTE:
                ...
                break;
			case SliderModel::STYLESLIDE_CAROUSEL_ONE:
                $this->setTemplate(self::STYLESLIDE_CAROUSEL_TEMPLATE);
                break;
            case SliderModel::STYLESLIDE_CAROUSEL_TWO:
                 $this->setTemplate(self::STYLESLIDE_INSTAGAM_TEMPLATE);
                // echo 'STYLESLIDE_CAROUSEL_TWO';
                break;
            case SliderModel::STYLESLIDE_CAROUSEL_THREE:
                 $this->setTemplate(self::STYLESLIDE_MOBILE_TEMPLATE);
                // echo 'STYLESLIDE_CAROUSEL_TWO';
                break;
    ...
    public function getBannerCollection()
    {
        ...
        $bannerData = $this->_bannerCollectionFactory->getBannerCollection($sliderId);
        if($bannerData)
        {
           return $bannerData; 
        }
        //echo "<pre>";print_R($bannerData->getData());
	...
	public function getCarouselsliderHtmlId()
    {
        return 'magestore_bannerslider_carousel_slider_'.$this->getSlider()->getId().$this->_stdlibDateTime->gmtTimestamp();
    }
}
