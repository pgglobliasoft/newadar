...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getSliderBannerUrl()
    {
        ...
        return $this->_backendUrl->getUrl('bannerslideradmin/slider/banners', ['_current' => true]);
    }
    public function getSliderBanneru()
    {
        return $this->_backendUrl->getUrl('bannerslideradmin/slider/banners');
    }
    /**
     * get Backend Url
     * @param  string $route
    ...
    public function getSliderModeAvailable()
    {
        return [
            ...
            Slider::STYLESLIDE_CAROUSEL_ONE => 'Carousel 1',
             Slider::STYLESLIDE_CAROUSEL_TWO =>'Instagram Slider',
             Slider::STYLESLIDE_CAROUSEL_THREE =>'Mobile Slider',
        ];
    }
    ...
    public function getStyleSlider()
    {
        return [
            [
                ...
                'label' => __('Mobile slider'),
                'value' => [['label' => __('Mobile Banner slider'),
                        'value' => Slider::STYLESLIDE_CAROUSEL_THREE,
                    ],
                ],
            ],
            [
                'label' => __('Instagram slider'),
                'value' => [['label' => __('Instagram Banner slider'),
                        'value' => Slider::STYLESLIDE_CAROUSEL_TWO,
                    ],
                ],
            ],
            [
			...
			[
                ...
                'value' => [
                    [
                        'label' => __('Carousel 1'),
                        'value' => Slider::STYLESLIDE_CAROUSEL_ONE,
                    ]
                ],
            ],
