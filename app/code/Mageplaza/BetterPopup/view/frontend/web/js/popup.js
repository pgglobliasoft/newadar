                ...
                if (this.options.dataPopup.isScroll) {  // show when scroll
                    ...
                    if (this.options.dataPopup.fullScreen.isFullScreen) {
                        if ($('#mp-popup-template3').length) {
                            $('#bio_ep').css({"width": "800px", "height": "auto"});
                        } else if ($('#mp-popup-template4').length) {
                            $('#bio_ep').css({"width": "605px", "height": "auto"});
                        } else if ($('#mp-popup-template5').length) {
                            $('#bio_ep').css({"width": "359px", "height": "auto"});
                        } else if ($('#mp-popup-template6').length) {
                            $('#bio_ep').css({"width": "500px","max-width": "80%", "min-height": "240px","transform":"scale(1), translateX(-50%) translateY(-50%) !important"});
                        }
                    }
                    self._fullScreen();
                }
                ...
                if (form.validation('isValid')) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.error) {
                                message_show1.html(data.msg);
                                    message_show1.addClass('message-error error');
                                    message_show1.removeClass('message-success');
                                    message_show1.show();
                                } else {
                                    $.ajax({
