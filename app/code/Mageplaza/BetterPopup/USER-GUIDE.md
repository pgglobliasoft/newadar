...
Now you remove `app/code/Mageplaza/BetterPopup` folder. In this step, you can copy override BetterPopup folder but this may cause of compilation issue. That why you should remove it.
