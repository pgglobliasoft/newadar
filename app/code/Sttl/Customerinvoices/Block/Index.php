...
class Index extends \Magento\Framework\View\Element\Template
{
	...
	public function getAllInvoicesData()
    {
        ...
        $field = ['DocNum','NumatCardPo','DocTotal'];

    	return $this->sapHelper->getInvoicesData($customer_number,$status,$date_from,$date_to,$start_from,0, $order_by, $opt,$serachinvoice,$field);
    }
	...
	public function getAjaxpreUrl(){
		return $this->sapHelper->getpreBaseUrl().'customerinvoices/getcustomer/';
	}
