 ...
 * Created By : RH
 */
namespace Sttl\Proupdated\Block\Adminhtml\Tab;
...
class BannerGrid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Sttl\Proupdated\Model\ResourceModel\PostFactory $productCollFactory,
    ...
    public function getSelectedProducts()
    {
        ...
        $model = $this->productCollFactory->create()->addFieldToFilter('id', $id);
        $grids = [];
