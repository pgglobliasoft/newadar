    	...
    	if(!empty($shipData))
    	{
			...
			foreach($shipData as $key => $data)
			{
				...
				if(!isset($shipDataArray['errors']))
				{
					...
					$description = '';
					$html .=$delivery_date_txt.'</div><div class="cf"><div class="trackingStatusBar"><div class="step1 '.$step1.'"></div><div class="step2 '.$step2.'"></div><div class="step3 '.$step3.'"></div><span class="shipStatus">';
