...
class Sidebar extends \Magento\Framework\View\Element\Template
{
    ...
    public function _construct()
    {
        ...
        $featureCollection->getSelect()->order('rand()');
        $featureCollection->getSelect()->limit($this->getConfig('sidebar_settings/number_of_features'));
        $featureCollection->addStoreFilter($this->_storeManager->getStore()->getId())
