...
class Product extends Extended
{
    ...
    public function __construct(
        ...
        \Sttl\Feature\Model\Resource\Product\CollectionFactory $productCollectionFactory,
        \Magento\Catalog\Model\Product\Attribute\Source\Status $status,
        \Magento\Catalog\Model\Product\Visibility $visibility,
        \Magento\Framework\Registry $coreRegistry,
        \Sttl\Feature\Model\Feature $featureFactory,
        array $data = []
    )
    {
    ...
    protected function _construct()
    {
        ...
        if ($this->getFeature() && $this->getFeature()->getId()) {
    ...
    public function getFeature()
    {
        ...
        return $this->_featureFactory->load($id);
    }
    ...
    public function getSelectedRelatedProducts()
    {
        ...
        $productCollection->addFieldToFilter('feature_id', ['eq' => $this->getFeature()->getId()]);
