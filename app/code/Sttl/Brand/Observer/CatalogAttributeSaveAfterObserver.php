        ...
        try {
            ...
            if ($attributeCode == 'sttl_brand') {
                ...
                foreach ($options as $option) {
                    ...
                    if ($value) {
                        $brandCollection = $objectManager->create('Sttl\Brand\Model\Brand')->getCollection();
                        ...
                        if (count($brandCollection)) {
                            ...
                            $brand = $objectManager->create('Sttl\Brand\Model\Brand');
                            $brand->setName($option->getLabel());
                            //$brand->setUrlKey($objectManager->get('Magento\Catalog\Model\Product\Url')->formatUrlKey($option->getLabel()));
