...
namespace Sttl\Brand\Block\Adminhtml\Brand\Edit\Tab;
...
use Sttl\Brand\Model\System\Config\Yesno;
...
class Main extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            'url_key',
            'text',
            ['name' => 'brand[url_key]', 'label' => __('URL Key'), 'title' => __('URL Key'), 'required' => true]
        );
        $fieldset->addField(
            'small_image',
            'image',
