...
class Stores extends AbstractExtensibleModel implements StockistInterface, RoutableInterface
{
     ...
     *
     * @param $location_remarks
     * @return StockistInterface
     */
    public function setLocationRemarks($location_remarks)
    {
        return $this->setData(StockistInterface::LOCATION_REMARKS, $location_remarks);
    }
    ...
    {
        return $this->getData(StockistInterface::LOCATION_REMARKS);
    }
}
